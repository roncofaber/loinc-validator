...
- **LOINC format assumption** — the format regex `^\d{1,6}-\d$` covers all codes present in LOINC 2.82 (1–6 leading digits, a dash, 1 check digit). If future releases introduce longer codes, the regex would need updating.
